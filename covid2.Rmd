...
tm_shape(regiao2.map) +
  tm_polygons(col='Letalidade', title="Letalidade", breaks=c(1.5, 2.0, 2.5, 3.5, 4.0), border.col = "white", palette="Oranges", popup.vars = c("Incidencia", "Mortalidade", "Letalidade"), title.col = "name_region") +
